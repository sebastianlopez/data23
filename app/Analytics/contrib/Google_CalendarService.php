...
class Google_CalendarService extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->colors       = new Google_ColorsServiceResource($this, $this->serviceName, 'colors',
            json_decode('{"methods": {"get": {"scopes": ["https://www.googleapis.com/auth/calendar", "https://www.googleapis.com/auth/calendar.readonly"], "path": "colors", "response": {"$ref": "Colors"}, "id": "calendar.colors.get", "httpMethod": "GET"}}}',
                true));
