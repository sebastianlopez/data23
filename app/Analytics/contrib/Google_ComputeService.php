...
class Google_InstancesServiceResource extends Google_ServiceResource
{
     ...
     * @return Google_Operation
     */
    public function addAccessConfig(
        $project,
        $instance,
        $network_interface,
...
class Google_MachineType extends Google_Model
{
    ...
    public function setAvailableZone(/* array(Google_object) */
        $availableZone
    ) {
...
class Google_Project extends Google_Model
{
    ...
    public function setQuotas(/* array(Google_ProjectQuotas) */
        $quotas
    ) {
...
class Google_Zone extends Google_Model
{
    ...
    public function setAvailableMachineType(/* array(Google_object) */
