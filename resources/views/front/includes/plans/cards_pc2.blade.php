            ...
            <div class="row justify-content-center text-center">
                <div class="myBarLeft2 typ-montserrat ">
                    ...
                    <nav class="nav nav-pills nav-fill myBarLeft2 ">
                        <a class="txt-black changePlan nav-link active" id="co-active" href="javascript:void(0)" data-flag="co">COP $</a>
                        <a class="txt-black changePlan nav-link" id="mxn-active" href="javascript:void(0)" data-flag="mx">MXN $</a>
                        <a class="txt-black changePlan nav-link" id="usd-active" href="javascript:void(0)" data-flag="ec">USD $</a>
                        <a class="txt-black changePlan nav-link" id="clp-active" href="javascript:void(0)" data-flag="ch">CLP $</a>
                        <a class="txt-black changePlan nav-link" id="pen-active" href="javascript:void(0)" data-flag="pe">PEN $</a></li>  
                    </nav>
                </div>
            </div>
               ...
               <div class="row justify-content-center text-center">
                ...
                <div class="card col-lg-3 col-md-8 px-3 pt-0 myPlansContainerB align-items-center">
                    <div class="card-body">
                        ...
                        <div class="mt-5" style="height: 10%">
                            <span class="txt-display  txt-black typ-montserrat font-sz-2 price0 price_" data-valor=0> $0</span>  
                             <p class="">&nbsp;</p>
                        </div>
                        ...
                        <div class="mt-1 mb-3" style="height: 10%;">
                            <h5 class="typ-montserrat"><b style="">{!! $site['p2_home_seccion_plangratuito_subtitle2'] ?? '' !!}</b></h5>
                            <span class="typ-txt-light typ-montserrat text-left">* 
                                <a class="myLink" href="https://www.datacrm.com/politicas/" target="_blank" rel="noopener noreferrer">
                        ...
                        <div class="typ-montserrat mt-5 mb-4">
                            <p>
                        ...
                        <div  class="typ-txt-light typ-montserrat mt-5 mb-3">
                            &nbsp;
                        </div>
                ...
                <div class="card col-lg-3 col-md-8 px-3 pt-0 myPlansContainerB align-items-center">
                    ...
                    <div class="card-body">
                        ...
                        <div class="align-items-center justify-content-center">
                            <h5 class="text-uppercase card-title txt-blue typ-montserrat f-sz-b font-weight-bold">
                                {!! $site['p2_home_seccion_planpro_title'] ?? '' !!}
                            </h5>
                        </div>
                        <!-- Precio -->
                        <div class="mt-5" style="height: 10%">
                            <span class="txt-display  txt-black typ-montserrat font-sz-2 price2 price_" data-valor=80000>
                        ...
                        <!-- implementacion -->
                        <div  class="typ-txt-light font-fm-montserrat-italic  mt-3 mb-3 px-5">
                            {!! $site['implementacion_planbasico_usuarios'] ?? '' !!} <span class="implementation"></span>
                        </div>
