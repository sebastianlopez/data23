...
@section('breadcrumb')
    <ol class="breadcrumb bread-main">
        ...
        <li class="breadcrumb-item"><a href="{{route('article_list')}}">Blog</a></li>
    </ol>
@endsection
            ...
            <div class="panel panel-default">
                ...
                <form class="validate-form" method="POST" enctype="multipart/form-data" action="">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="info">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 form-group">
                                        ...
                                        {!! Form::select('dat[category_id]',$categories,$reg->category_id ?? 0, array('class'=>'form-control')) !!}
                                    </div>
                                    <div class="col-lg-2">
                    ...
                    <div class="panel-footer bg-white">
                        ...
                        <a href="{{route('article_list')}}" class="btn btn-default">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
