    ...
    (function (H) {
        ...
        H.Axis.prototype = {
            ...
            setTickInterval: function (secondPass) {
                ...
                if (isLog) {
                    if (
                        axis.positiveValuesOnly && !secondPass &&
            ...
            setTickPositions: function () {
                ...
                this.single = this.min === this.max && defined(this.min) && !this.tickAmount && options.allowDecimals !== false;
        ...
        seriesType('spline', 'line', {}, /** @lends seriesTypes.spline.prototype */ {
            ...
            getPointSpline: function (points, point, i) {
                ...
                function doCurve(otherPoint) {
                    return otherPoint && !otherPoint.isNull &&
                        otherPoint.doCurve !== false && !point.isCliff; // #6387, area splines next to null
                }
