(function (window) {
    ...
    function plans() {
        ...
        var setData = function () {
            clickModalPaymensAcom();
            clickModalPaymentsView();
            changePrice();
            submitPayments();
            getCountry();
            changePlan();
        ...
        function clickModalPaymensAcom() {
            $(".modalPagosAcom").on("click", function () {
                $('#usuariosPayu').prop('required', false);
                $("#typeForm").val("accompaniment");
                $("#check_accompaniment").prop("checked", true);
                ...
                modal = "#modalPagos";
                $(modal).modal("show");
                $(".pagotitle").html('Plan de acompañamiento (Pago Único)');
                $(".pagotitle").css('font-size', '22px');
                $("#users").hide();
                //$("#optionsPlans").hide();
                let tax = $('.tax_co_value').val();
                let accompaniment = $(".valueAccompaniment").val();
                $(".totalPago").html(accompaniment);
                $(".tax_co").html(tax);
                $('#pay').addClass('mt-4');
        ...
        function getCountry() {
            ...
            var country = (countryCode) ? countryCode : $("#country").val();
        ...
        function changePlan(c = false) {
            ...
            if (tipo_pago_checked == "pagoAnualLabel") {
                ...
                switch (c) {
                    ...
                    case 'mx':
                        ...
                        document_id = 'CURP';
                        break;
                    case 'ec': case 'pa': case 'cr': case 'ch': case 'pe':
                        valor1 = 12;
                        valor2 = 16;
                        accompaniment = 100;
                        type_page = 'anual';
            ...
            $(".accompaniment").html("$" + number_format(accompaniment, 0, ',', '.') + " " + simbolo_money).data('valor', accompaniment);
            $(".price0").html("$" + number_format(valor0, 0, ',', '.')).data('valor', valor0);
            $(".price1").html("$" + number_format(valor1, 0, ',', '.') + "<span style='font-size: 1.3rem'>" + simbolo_money + "</span>").data('valor', valor1);
            $(".price2").html("$" + number_format(valor2, 0, ',', '.') + "<span style='font-size: 1.3rem'>" + simbolo_money + "</span>").data('valor', valor2);
